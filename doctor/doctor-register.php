...
$result1 = mysqli_query($conn, "SELECT * FROM doctors WHERE doctor_email = '" . $sess_email . "' ");
$row1 = mysqli_fetch_assoc($result1);
$business_id = $row1["business_id"];

$result = mysqli_query($conn, "SELECT * FROM business WHERE business_id = '" . $business_id . "' ");
            ...
            <div class="register-wrap">
                ...
                <div class="tab">
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="inputBusinessName" class="form-control input" id="inputBusinessName" placeholder="Enter Name" value="<?php echo $row["business_name"]; ?>">
                        </div>
                    </div>
                ...
                <div class="tab">
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="inputContact" class="form-control input" id="inputContact" placeholder="Enter Phone Number" value="<?php echo $row["business_contact"]; ?>">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="inputEmailAddress">Email Address*</label>
                            <input type="text" name="inputEmailAddress" class="form-control input" id="inputEmailAddress" placeholder="Enter Email Address" value="<?php echo $row["business_email"]; ?>">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="inputURL">URL Link</label>
                            <input type="text" name="inputURL" class="form-control input" id="inputURL" placeholder="Enter URL" value="<?php echo $row["business_url"]; ?>">
                        </div>
                    </div>
                </div>
                ...
                <div class="tab">
                    <div class="form-group">
                        ...
                        <input type="text" name="inputAddress" class="form-control input" id="inputAddress" onfocus="geolocate()" oninput="map_marker()" placeholder="1234 Main St" value="<?php echo $row["business_address"]; ?>">
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="inputCity">City</label>
                            <input type="text" name="inputCity" class="form-control input" id="inputCity" oninput="map_marker()" value="<?php echo $row["business_city"]; ?>">
                        </div>
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <input type="text" name="inputZipCode" class="form-control input" id="inputZipCode" oninput="map_marker()" value="<?php echo $row["business_zipcode"]; ?>">
                        </div>
                    </div>
                    <!-- <div class="form-group">
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $status = "0";
    $business_name = escape_input($_POST["inputBusinessName"]);
    ...
    // Check Email Valid
    $businesstmt = $conn->prepare("SELECT * FROM business WHERE business_email = ?");
    $businesstmt->bind_param("s", $email);
    $businessresult = $businesstmt->get_result();

    $businessstmt = $conn->prepare("UPDATE appointment_hour SET open_week = ?, close_week = ?, open_sat = ?, close_sat = ?, open_sun = ?, close_sun = ? WHERE business_id = ?");
    $businessstmt->bind_param("sssssss", $weekopen, $weekclose, $satopen, $satclose, $sunopen, $sunclose, $business_id);
    ...
    $updatestmt = $conn->prepare("UPDATE business SET business_name = ?, business_email = ?, business_url = ?, business_contact = ?, business_address = ?, business_city = ?, business_state = ?, business_zipcode = ?, business_status = ? WHERE business_id = ?");
    $updatestmt->bind_param("ssssssssss", $business_name, $email, $url, $contact, $address, $city, $state, $zipcode, $status, $business_id);
